...
class AttendanceSerializer(serializers.Serializer):
    ...
    date = serializers.DateField()
    status = serializers.ChoiceField(choices=['present', 'absent'], default='present')
    marked_by = serializers.CharField(source='marked_by_id', read_only=True, required=False)
    marked_by_name = serializers.CharField(read_only=True, required=False)
    marked_at = serializers.CharField(read_only=True, required=False)
